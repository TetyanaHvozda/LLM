# Fine-tuning the pre-trained LLM to follow instructions
# Stage 1. Preparing the dataset
# Downloading the instruction dataset (publicly available instruction datasets in appendix B)
import json
import os
import requests
...
# Format the input to pass to the LLM
...
# Final custom batch collate function
...
#After preparing the dataset and loading a pretrained model, we
# now fine-tune the model on the instruction data.
from chapter_5 import (
    calc_loss_loader,
    train_model_simple
)
